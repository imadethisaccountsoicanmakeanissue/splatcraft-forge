...
public class TarpSquidRenderer extends LivingEntityRenderer<LivingEntity, TarpSquidModel> implements RenderLayerParent<LivingEntity, TarpSquidModel>
{

	private static EntityRendererProvider.Context squidFormContext;
	private static final ResourceLocation TEXTURE = new ResourceLocation(Splatcraft.MODID, "textures/entity/tarp.png");

	public TarpSquidRenderer(EntityRendererProvider.Context context)
	{
		super(context, new TarpSquidModel(context.bakeLayer(TarpSquidModel.LAYER_LOCATION)), 0.5f);
